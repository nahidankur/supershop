...
import { productList, productDetails,productDelete,productUpdate, productCreate} from './reducers/productReducer'
...
const reducer = combineReducers({
    ...
    productCreate, productUpdate, orderList, orderDeliver
})
